...
switch(value) {
	case '2':
		WebUI.waitForElementPresent(findTestObject('Object Repository/WALLET/Pages/walletTransaction/dynamicTransactionXPath/elementByClassText',[('class'):"tw-whitespace-nowrap",('text'): result]),GlobalVariable.G_TIMEOUT)
		
		WebUI.verifyElementPresent(findTestObject('Object Repository/WALLET/Pages/walletTransaction/dynamicTransactionXPath/elementByClassText',[('class'):"tw-whitespace-nowrap",('text'): result]),GlobalVariable.G_TIMEOUT)
