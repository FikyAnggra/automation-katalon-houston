...
WebUI.waitForElementPresent(findTestObject('Object Repository/WALLET/Pages/walletTransaction/dynamicTransactionXPath/elementOptionByValue', [('elementOptionByValue') : '10']), GlobalVariable.G_TIMEOUT)
