...
def filterByDate() {
	...
	if (testCase.equals("Success Filter By Date")) {
		WebUI.waitForElementPresent(findTestObject('Object Repository/WALLET/Pages/walletTransaction/withdrawIDR/date', [('date') : filterResult]),GlobalVariable.G_TIMEOUT)

		WebUI.verifyElementPresent(findTestObject('Object Repository/WALLET/Pages/walletTransaction/withdrawIDR/date', [('date') : filterResult]), GlobalVariable.G_TIMEOUT)
	}else {
