...
def filterByOneCoin(){
	...
	for (int row=0; row < rowsCount; row++) {
		WebUI.verifyElementPresent(findTestObject('PROEARN/Pages/General/twoElementByText', [('elementOne') :'tr'+[row+1], ('elementTwo') : 'td'+[3], ('elementTag') : '*' , ('twoElementByText'): filterResult]), 0, FailureHandling.STOP_ON_FAILURE)
	}
}
