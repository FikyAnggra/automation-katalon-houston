...
def setupStakingPage() {
    ...
    WebUI.verifyElementPresent(findTestObject('PROEARN/Pages/General/elementTagByParameter', [('elementTag') : 'li' , ('elementParameter') : 'permissions' , ('elementValue') : 'trx_earn_saving']), GlobalVariable.G_TIMEOUT)
	
	WebUI.click(findTestObject('PROEARN/Pages/General/elementTagByParameter', [('elementTag') : 'li' , ('elementParameter') : 'permissions' , ('elementValue') : 'trx_earn_saving']), FailureHandling.STOP_ON_FAILURE)
...
def filterByDate() {
	...
	WebUI.click(findTestObject('PROEARN/Pages/General/twoElementTagByParameterAndText', [('elementTagOne') :'*', ('elementParameterOne') :'class' , ('elementValueOne') : 'tw-min-w-min dropdown-menu show', ('elementTagTwo') : '*' , ('elementParameterTwo') :'class' , ('elementValueTwo'): 'date-picker__year-button-wrapper', ('elementTagText') : '*', ('elementByText') : endDate[2]]), FailureHandling.STOP_ON_FAILURE)

	WebUI.click(findTestObject('PROEARN/Pages/General/twoElementTagByParameterAndText', [('elementTagOne') :'*', ('elementParameterOne') :'class' , ('elementValueOne') : 'tw-min-w-min dropdown-menu show', ('elementTagTwo') : '*' , ('elementParameterTwo') :'class' , ('elementValueTwo'): 'date-picker__month-button-wrapper', ('elementTagText') : '*', ('elementByText') : endDate[1]]), FailureHandling.STOP_ON_FAILURE)
    ...
    if (testCase.equals('Success Filter By Date')) {
		...
		WebUI.waitForElementPresent(findTestObject('PROEARN/Pages/General/elementTagByText', [('elementTag') : 'div', ('elementByText'): filterResult]), GlobalVariable.G_TIMEOUT)
		
		WebUI.verifyElementPresent(findTestObject('PROEARN/Pages/General/elementTagByText', [('elementTag') : 'div', ('elementByText'): filterResult]), GlobalVariable.G_TIMEOUT)
    }
}
