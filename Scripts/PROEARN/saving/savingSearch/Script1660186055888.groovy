...
def setupStakingPage() {
	...
	WebUI.verifyElementPresent(findTestObject('PROEARN/Pages/General/elementTagByParameter', [('elementTag') : '*' , ('elementParameter') : 'placeholder', ('elementValue') : search]), GlobalVariable.G_TIMEOUT)
...
def successSearchBy() {
	...
	WebUI.setText(findTestObject('PROEARN/Pages/General/elementTagByParameter', [('elementTag') : '*' , ('elementParameter') : 'placeholder', ('elementValue') : search]), searchBy)
