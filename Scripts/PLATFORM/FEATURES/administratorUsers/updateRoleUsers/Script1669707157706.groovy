...
WebUI.verifyElementPresent(findTestObject('PLATFORM/Pages/AdministratorUserPage/elementByText', [('element') : 'Admin successfully updated!']), GlobalVariable.G_SHORTTIMEOUT)