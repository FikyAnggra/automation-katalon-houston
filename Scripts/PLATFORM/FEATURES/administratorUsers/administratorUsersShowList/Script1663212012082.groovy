...
WebUI.waitForElementPresent(findTestObject('PLATFORM/Pages/AdministratorUserPage/elementByText', [('element') : 'Registered Date']), 
    GlobalVariable.G_TIMEOUT)

WebUI.verifyElementPresent(findTestObject('PLATFORM/Pages/AdministratorUserPage/elementByText', [('element') : 'Registered Date']), 
    GlobalVariable.G_TIMEOUT)
