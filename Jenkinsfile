...
pipeline {
    ...
    stages {
        ...
        stage('Test') {
            steps {
              bat 'katalon -noSplash -runMode=ui -projectPath="C:\ProgramData\Jenkins\.jenkins\workspace\automation-katalon-houston" -testSuitePath="Test Suites/regressionEarn2.0Features" -browserType="Chrome" -retry=0 -statusDelay=15'
            }
        }
    }
}
